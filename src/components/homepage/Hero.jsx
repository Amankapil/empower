        ...
        <div className='max-w-[68rem] mx-auto h[500px]  mt-[8%]'>
          <div className='content w-[50%] flex flex-col justify-start items-start max-lg:w-full'>
            ...
            <div className='button-hero flex  max-md:flex-wrap'>
              <Link
                href='/services'
                className='one  text-[#fff] font-normal text-[12px] tracking-[1px] inlin-block px-[22px] py-[10px] rounded-[50px] [transition:0.5s] m-[10px] border-[1px] border-[solid] border-[#1d83b3] bg-[#1d83b3] text-center w-[238px]  flex justify-center items-center gap-2 hover:bg-[transparent] hover:border-[#fff]'
              >
              ...
              <Link
                ...
                className='one  text-[#fff] font-normal text-[12px] tracking-[1px] inlineblock px-[22px] py-[10px] rounded-[50px] [transition:0.5s] m-[10px] border-[1px] border-[solid] border-[#ffffff] text-center w-[250px] flex justify-center items-center gap-2 hover:bg-[#1d83b3] hover:border-[#1d83b3]'
              >
                <Image src={img} alt='' />
