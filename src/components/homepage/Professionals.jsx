          ...
          <div className="col12 flex justify-center items-start gap-10 max-md:w-full max-md:flex-wrap">
            ...
            <div className="max-md:p-5 boxw">
              ...
              <p className="leading-[24px] text-[#000] mb-[30px] mt-8">
                <b>Integrity : </b>
                Upholding honest, transparent, and ethical behavior in all
                dealings, building trust with integrity as our cornerstone.
                <br />
                <b>Commitment : </b>
                Demonstrating unwavering dedication to our mission, values, and
                stakeholders, driving us to go above and beyond in all that we
                do.
                <br />
                <b>Collaboration : </b>
                Encouraging teamwork, open communication, and mutual respect to
                achieve common goals and foster a supportive work environment.
              </p>
              {/* <Link
                href="/About"
